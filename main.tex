...
\thesistitle{Preferencias en la planificación de rutas} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\thesistitleEnglish{THESIS TITLE} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitleEnglish
\supervisor{Javiera Barrera\\Luis Aburto\\Felipe Lagos} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Felipe Jesús Meneses Machuca} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\keywords{machine learning, clasificación, apelación, salud} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\include{Chapters/EstadoArte}
\include{Chapters/Hipotesis}
